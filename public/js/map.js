...
},{"bootstrap":1,"jquery":3}],5:[function(require,module,exports){
'use strict';
...
exports.setupMarkers = function (data) {
    ...
    try {
        for (var _iterator = data.data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            var color = modelGet(model, color_key);
            if (color_mode === 'name') color = color_table[color];
...
function modelGet(model, key) {
    ...
    try {
        for (var _iterator4 = key.split('.')[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
function markerListener(infoWindow, marker) {
    return function () {
        ...
        try {
            for (var _iterator5 = info_windows[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
},{"./app.js":4,"./modules/array_unique.js":6,"google-maps":2,"jquery":3}],6:[function(require,module,exports){
"use strict";
